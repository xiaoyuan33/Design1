...
<title>Insert title here</title>
 <meta content="IE=edge,chrome=1" http-equiv="X-UA-Compatible">
     ...
     <link rel="stylesheet" type="text/css" href="/Design/lib/bootstrap/css/bootstrap.css">
...
<div class="navbar">
	...
	<div class="sidebar-nav">
		...
		<a href="#news-menu" class="nav-header" data-toggle="collapse" ><i class="icon-question-sign"></i>消息管理</a>
                  <ul id="news-menu" class="nav nav-list collapse">
                      <li ><a href="/Design/page.jsp">发布消息</a></li> 
                      <li ><a href="/Design/page-list.jsp">回复消息</a></li> 
                  </ul>
                  <a href="#files-menu" class="nav-header" data-toggle="collapse"><i class="icon-comment"></i>文件管理</a>
	...
	<div class="content">
		...
		<ul class="breadcrumb">
			...
			<li><a href="users.html">监考管理</a> <span class="divider">/</span></li>
		...
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<form action="../allotexam" method="post">
					<label>考试</label> <select name="examId" id="examId"></select><br />
					<label>监考人</label> <select multiple="multiple" name="userId"
						id="userId"></select><br /> <input type="submit"
						name="jiankaofenpei" value="确认分配"> 
				</form>
				<br />
