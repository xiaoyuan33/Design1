			...
			<div class="row-fluid">
				...
				<div class="well">
					<ul class="nav nav-tabs">
						<li class="active"><a href="#home" data-toggle="tab">注册信息</a></li>
					</ul>
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active in" id="home">
							<form id="tab" action="adduser" method="POST">
								<label>用户名</label> <input type="text" value=""
									class="input-xlarge" name="name"> <label>密码</label> <input
									type="password" value="" class="input-xlarge" name="password">
								...
								<label>电话</label> <input type="text" value=""
									...
									type="submit" name="tianjiayonghu" value="确认添加">
							</form>
						</div>
					</div>
				</div>
